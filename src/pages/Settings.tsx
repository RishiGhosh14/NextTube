    ...
    <>
      ...
      <Layout closeSidebar={false}>
        <>
          ...
          <div className="space-y-10 divide-y divide-primary">
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 pt-10 md:grid-cols-3">
              ...
              <form className="bg-base-300 shadow-sm ring-1 ring-primary sm:rounded-xl md:col-span-2">
                    ...
                    <div className="sm:col-span-3">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          className="focus:ring-primary-600 block w-full rounded-md border-0 py-1.5 text-primary shadow-sm ring-1 ring-inset ring-primary placeholder:text-secondary focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                    ...
                    <div className="sm:col-span-4">
                      ...
                      <div className="mt-2">
                        <input
                          ...
                          value={user.email || ""}
                          onChange={handleInputChange}
                          className="focus:ring-primary-600 block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-primary placeholder:text-secondary focus:ring-2 focus:ring-primary focus:ring-inset sm:text-sm sm:leading-6"
                        />
                      </div>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3 pt-5">
              ...
              <form className="bg-base-100   shadow-sm ring-1 ring-primary sm:rounded-xl md:col-span-2">
                <div className="px-4 py-6 sm:p-8">
                  <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div className="sm:col-span-4">
                      <label
                      ...
                      <div className="mt-2">
                        <div className="focus-within:ring-primary-600 flex rounded-md shadow-sm ring-1 ring-inset ring-primary focus-within:ring-2 focus-within:ring-inset sm:max-w-md">
                          <span className="flex select-none items-center pl-3 text-primary sm:text-sm">
                            nexttube .com/
                          </span>
                          <input
                            type="text"
                            name="handle"
                            id="handle"
                            className="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-primary placeholder:text-secondary focus:ring-0 sm:text-sm sm:leading-6"
                            value={user.handle || ""}
                            onChange={handleInputChange}
                          />
                        </div>
                    ...
                    <div className="col-span-full">
                      ...
                      <div className="mt-2">
                        <textarea
                          ...
                          name="description"
                          rows={3}
                          className="focus:ring-primary-600 block w-full rounded-md border-0 py-1.5  shadow-sm ring-1 ring-inset ring-primary placeholder:text-secondary focus:ring-2 focus:ring-inset sm:text-sm sm:leading-6"
                ...
                <div className="flex items-center justify-end gap-x-6 border-t border-primary px-4 py-4 sm:px-8">
                  <Button
                    variant={"default"}
                    size="lg"
        ...
        <Dialog as="div" className="relative z-10" onClose={setOpen}>
          ...
          <div className="fixed inset-0 z-10 overflow-y-auto">
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-transparent px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-sm sm:p-6">
                  <>
                    <ImageCropper
