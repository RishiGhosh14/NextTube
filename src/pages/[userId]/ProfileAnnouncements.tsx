      ...
      <Layout>
        <>
              ...
              <div className=" relative mt-2 flex flex-row gap-2">
                <div className="w-full">
                  <textarea
                    ...
                    className="block w-full rounded-md border-0 p-4 py-1.5 text-primary shadow-sm ring-1 ring-inset ring-primary placeholder:text-secondary focus:ring-2 focus:ring-inset focus:ring-primary sm:text-sm sm:leading-6"
                ...
                <div className="flex-shrink-0">
                  <Button
                    type="submit"
                    className="inline-flex items-center rounded-md  px-3 py-2 text-sm font-semibold  shadow-sm hover:bg-primary-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary-600"
                  >
                    Post
                  </Button>
                </div>
          ...
          {errorTypes ? (
            ...
            <ul role="list" className="-pt-8 divide-y divide-primary">
              {announcements
                ?.sort(
                  (a, b) =>
